  ...
  return (
    <section className="relative py-16 px-4 text-center bg-gradient-hero overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        >
            <div className="bg-gradient-card backdrop-blur-sm rounded-xl p-4 mb-6 border border-gold/30 shadow-glow max-w-xs mx-auto hover-scale">
              <div className="flex items-center justify-center gap-2 mb-1">
                <span className="text-muted-foreground line-through text-sm">R$ 79,90</span>
                <Badge className="bg-destructive text-destructive-foreground text-xs animate-pulse">63% OFF</Badge>
              </div>
              <div className="text-3xl font-bold text-gold">R$ 29,90</div>
              <p className="text-xs text-gold font-bold">💎 ACESSO VITALÍCIO</p>
              <p className="text-xs text-muted-foreground">Sem mensalidade • Para sempre!</p>
            </div>
