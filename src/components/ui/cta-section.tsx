  ...
  return (
    <section className="py-16 px-4 bg-gradient-to-br from-background via-card/20 to-background relative overflow-hidden">
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <div 
          ref={priceRef}
          className={`bg-gradient-card backdrop-blur-sm rounded-xl p-6 mb-6 border border-gold/50 shadow-glow max-w-sm mx-auto transition-all duration-700 delay-200 ${
        ...
        >
          ...
          <div className="text-4xl font-bold text-gold mb-1">R$ 29,90</div>
          <p className="text-sm text-gold font-bold mb-2">
            💎 ACESSO VITALÍCIO
          </p>
          <p className="text-sm text-muted-foreground mb-2">Pague uma vez • Use para sempre</p>
          <p className="text-xs text-destructive font-medium animate-pulse">
            🚨 Últimas 24h da promoção!
          </p>
        </div>
